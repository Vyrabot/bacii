...
function ScoreHistoryPanel({ entries, track, language, t, onRemove, onClear, isDark, onEdit, onView }) {
    ...
    return (
        <div className={`h-fit overflow-hidden rounded-3xl border transition-all duration-300 ${isDark ? "bg-dark-secondary/80 border-white/10" : "bg-white/80 border-white/40"
            } shadow-lg backdrop-blur-md`}>
            <div
                onClick={() => setIsOpen(!isOpen)}
                className={`flex cursor-pointer items-center justify-between p-5 transition-colors ${isDark ? "hover:bg-white/5" : "hover:bg-black/5"
                    }`}
            >
                                ...
                                <div className="space-y-2">
                                    {grouped[monthKey].map((entry) => {
                                        ...
                                        return (
                                            <div
                                                key={entry.id}
                                                className={`group relative flex items-center justify-between gap-3 rounded-2xl border p-4 transition-all hover:shadow-lg ${isDark ? "bg-dark-primary/60 border-white/10" : "bg-white/60 border-slate-100"
                                                    }`}
                                            >
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        <div className="flex gap-1 sm:gap-2">
                                                            <button
                                                                ...
                                                                className={`p-2 rounded-lg transition-all ${isDark ? "bg-blue-500/10 text-blue-400 hover:bg-blue-500/20" : "bg-blue-50 text-blue-600 hover:bg-blue-100"
                                                                    }`}
                                                                title={t("view")}
                                                            >
                                                                <FaEye size={14} />
                                                            ...
                                                            <button
                                                                ...
                                                                className={`p-2 rounded-lg transition-all ${isDark ? "bg-white/5 text-blue-300 hover:bg-white/10" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
                                                                    }`}
                                                                title={t("edit")}
                                                            >
                                                                <FaEdit size={14} />
                                                            ...
                                                            <button
                                                                ...
                                                                className={`p-2 rounded-lg transition-all ${isDark ? "bg-red-500/10 text-red-400 hover:bg-red-500/20" : "bg-red-50 text-red-500 hover:bg-red-100"
                                                                    }`}
                                                                title={t("remove")}
                                                            >
                                                                <FaTrash size={14} />
